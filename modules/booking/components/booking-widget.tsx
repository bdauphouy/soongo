...
import { CalendarCheck, X } from "@phosphor-icons/react/ssr";
import { Button } from "@/components/ui/button";
import { onOpenBookingDemo } from "@/modules/booking/lib/booking-demo";
    ...
    <div className="fixed bottom-5 right-5 z-50 sm:bottom-6 sm:right-6">
      {rendered && (
        <div
          ...
          className={`${open ? "animate-bounce-in" : "animate-bounce-out"} absolute bottom-[calc(100%+0.75rem)] right-0 flex h-128 w-[calc(100vw-2.5rem)] max-w-96 flex-col overflow-hidden rounded-3xl border border-border bg-card shadow-2xl shadow-ink/15`}
        >
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {CAL_LINK ? (
              ...
              <div className="flex min-h-104 flex-col items-center justify-center gap-4 px-6 text-center">
