...
export function HeroVisual() {
  return (
    <div className="relative mx-auto w-full max-w-[480px]">
      ...
      <div className="rounded-3xl border border-border bg-card p-5 transition-transform duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-1.5 hover:scale-[1.01] sm:p-6">
      ...
      <div className="absolute -bottom-7 -left-6 w-60 sm:-left-10">
        <div className="animate-bounce-in relative flex items-start gap-3 rounded-[1.4rem] rounded-bl-md border border-border bg-card p-4 transition-transform duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-1 hover:scale-[1.03]">
